...
INSERT INTO MANAGED_RESOURCE (id, resource_identifier, resource_type, friendly_name, description, status) VALUES
    (102, 'io.spring.iam.admin.iam.service.impl.DocumentService.getDocumentById(java.lang.Long)', 'METHOD', '특정 문서 조회', 'ID로 특정 문서를 조회하는 핵심 서비스 메서드', 'PERMISSION_CREATED')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO POLICY_TARGET (id, policy_id, target_type, target_identifier) VALUES
    (201, 201, 'METHOD', 'io.spring.iam.admin.iam.service.impl.DocumentService.getDocumentById(java.lang.Long)')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO MANAGED_RESOURCE (id, resource_identifier, resource_type, friendly_name, description, status) VALUES
    (201, 'io.spring.iam.admin.iam.service.impl.DocumentService.updateDocument(java.lang.Long,java.lang.String)', 'METHOD', '문서 업데이트', 'ID와 새로운 내용으로 문서를 업데이트하는 기능', 'POLICY_CONNECTED')
ON CONFLICT (id) DO NOTHING;
