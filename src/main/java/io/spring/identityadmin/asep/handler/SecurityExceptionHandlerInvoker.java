package io.spring.identityadmin.asep.handler;

import io.spring.identityadmin.asep.annotation.CaughtException;
import io.spring.identityadmin.asep.handler.argumentresolver.SecurityHandlerMethodArgumentResolver;
