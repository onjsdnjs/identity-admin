...
public class ConditionClassificationController {
    ...
    public ResponseEntity<Map<String, Object>> generateManagedResourceBasedTemplates() {
        ...
        try {
            List<ConditionTemplate> generatedTemplates = autoConditionTemplateService.generateManagedResourceBasedTemplates();
    ...
    public ResponseEntity<Map<String, Object>> generatePermissionBasedTemplates() {
        ...
        try {
            List<ConditionTemplate> generatedTemplates = autoConditionTemplateService.generatePermissionBasedTemplates();
