...
public interface PermissionRepository extends JpaRepository<Permission, Long> {
    ...
    @Query("SELECT p FROM Permission p " +
            ...
            "WHERE mr.status <> io.spring.iam.domain.entity.ManagedResource.Status.NEEDS_DEFINITION " +
            "AND mr.status <> io.spring.iam.domain.entity.ManagedResource.Status.EXCLUDED")
