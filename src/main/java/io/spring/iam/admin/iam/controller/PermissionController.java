...
import io.spring.iam.domain.entity.FunctionCatalog; // 복원된 메서드에서 사용하므로 import 추가
import io.spring.iam.domain.entity.ManagedResource;
import io.spring.iam.domain.entity.Permission;
import io.spring.iam.admin.metadata.service.FunctionCatalogService; // 복원된 메서드에서 사용하므로 import 추가
