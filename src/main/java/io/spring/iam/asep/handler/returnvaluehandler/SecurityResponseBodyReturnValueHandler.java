package io.spring.iam.asep.handler.returnvaluehandler;

import io.spring.iam.asep.annotation.SecurityResponseBody;
import io.spring.iam.asep.handler.model.HandlerMethod;
