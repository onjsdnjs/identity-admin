...
import io.spring.iam.aiam.dto.*;
import io.spring.iam.domain.dto.AiGeneratedPolicyDraftDto;
import io.spring.iam.domain.dto.BusinessPolicyDto;
...
import io.spring.iam.repository.*;
import io.spring.iam.resource.service.ConditionCompatibilityService;
import io.spring.iam.security.xacml.pap.service.BusinessPolicyService;
...
import static io.spring.iam.domain.entity.policy.Policy.Effect.ALLOW;
...
public class AINativeIAMSynapseArbiterFromOllama implements AINativeIAMAdvisor {
    ...
    **참고 컨텍스트:**
    ...
    private String buildSystemMetadata(io.spring.iam.aiam.dto.PolicyGenerationRequest.AvailableItems availableItems) {
     ...
     */
    public AiGeneratedPolicyDraftDto generatePolicyFromTextByAi(String naturalLanguageQuery, PolicyGenerationRequest.AvailableItems availableItems) {
        // RAG 검색
        SearchRequest searchRequest = SearchRequest.builder()
                .query(naturalLanguageQuery)
                .topK(10)
